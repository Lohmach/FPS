...
public class AI_enemy3 : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (global_variables.enemy3_hp <= 0)
        {
            Destroy(gameObject);
            global_variables.total_Points += From_enemy_to_player * 2f * global_variables.speed;
        ...
        myTransform.position += myTransform.forward * 20 * Time.deltaTime * global_variables.speed;
